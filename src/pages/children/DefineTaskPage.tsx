...
import { ArrowLeftIcon, CurrencyDollarIcon, PlusIcon, TrashIcon, CheckIcon, QuestionMarkCircleIcon } from '@heroicons/react/24/outline';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white" dir="rtl">
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 bg-gradient-to-br from-yellow-50 to-yellow-100 px-4 py-2.5 rounded-xl">
              <CurrencyDollarIcon className="w-6 h-6 text-yellow-600" />
              <span className="font-bold text-yellow-700 text-lg">دیجیت</span>
            </div>
            <button
              onClick={() => setShowDigitGuide(true)}
              className="p-2 hover:bg-gray-100 rounded-full transition-colors"
            >
              <QuestionMarkCircleIcon className="w-5 h-5 text-gray-500 hover:text-gray-700" />
            </button>
          </div>
        </div>
        ...
        {tasks.length === 0 ? (
          ...
          >
            <div className="rounded-full w-24 h-24 flex items-center justify-center mb-6 bg-gradient-to-br from-yellow-100 to-yellow-200">
              ...
              {tasks.map((task, index) => (
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <h4 className="font-bold text-gray-900 mb-2 text-lg">{task.title}</h4>
                      <div className="flex items-center gap-2">
                        <div className="flex items-center gap-1.5 bg-gradient-to-r from-yellow-50 to-yellow-100 text-yellow-700 px-3 py-1.5 rounded-full border border-yellow-200">
                          ...
                          <span className="text-sm font-semibold">{task.reward} دیجیت</span>
                        </div>
                      </div>
                    </div>
                    <button
      ...
      <motion.button
        ...
        className="fixed bottom-6 left-1/2 -translate-x-1/2 w-14 h-14 bg-gradient-to-br from-gray-800 to-gray-900 text-white rounded-full shadow-2xl flex items-center justify-center z-20 hover:shadow-gray-900/50 transition-all"
      >
      ...
      >
        <div className="space-y-6">
          <div className="space-y-2">
            <label htmlFor="taskTitle" className="block text-sm font-semibold text-gray-700">
              عنوان تسک
            </label>
            <input
              type="text"
          ...
          <div className="space-y-2">
            <label htmlFor="taskReward" className="block text-sm font-semibold text-gray-700">
              مقدار دیجیت
            </label>
            <input
              type="number"
      ...
      >
        <div className="space-y-6">
          <div className="flex items-center justify-center mb-4">
            <div className="rounded-full w-20 h-20 flex items-center justify-center bg-gradient-to-br from-yellow-100 to-yellow-200">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            <p className="text-base">
              <strong className="text-gray-900">دیجیت</strong> یک واحد پاداش دیجیتالی است که فرزند شما با انجام تسک‌ها و فعالیت‌های مختلف می‌تواند کسب کند.
            </p>
            
            <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl p-4 space-y-2 border border-yellow-200">
              <h4 className="font-bold text-gray-900 mb-2">کاربردهای دیجیت:</h4>
            ...
            <p className="text-sm text-gray-600">
              با تعریف تسک‌های مختلف برای فرزند خود، می‌توانید به او کمک کنید تا با انجام کارهای مفید، دیجیت کسب کند و مدیریت مالی را یاد بگیرد.
            </p>
          </div>
        </div>
      </Modal>
